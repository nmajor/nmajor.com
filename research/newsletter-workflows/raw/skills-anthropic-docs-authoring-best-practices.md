# RAW: Anthropic official docs -- Skill authoring best practices + Agent Skills overview

- URLs:
  - https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices (markdown source fetched from .../best-practices.md)
  - https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview (markdown source fetched from .../overview.md)
- Date accessed: 2026-08-18
- What it is: Anthropic's canonical guidance on how to write a skill -- description-writing, progressive disclosure, context budget, degrees of freedom, evaluation-first authoring.
- NOTE: WebFetch refused to reproduce this verbatim on copyright grounds; the text below was fetched directly from the docs' own markdown endpoints and is unmodified.
