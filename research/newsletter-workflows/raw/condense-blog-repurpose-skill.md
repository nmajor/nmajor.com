# codex-skills `blog-repurpose` — a published, complete one-piece-to-many-platforms atomization skill

- URL: https://github.com/megastep/codex-skills/blob/main/blog-repurpose/SKILL.md
- Date accessed: 2026-08-18
- What it is: The nearest public analogue to our `content-repurposing` skill — a full SKILL.md that extracts a fixed set of "atoms" from a post, then re-forms them per platform with explicit per-platform hook patterns, length budgets, and formatting rules. Cloned via `gh repo clone megastep/codex-skills`. Reproduced complete and verbatim below. (Note: several of its defaults are the opposite of Nick's house rules — it mandates hashtags, engagement-bait closers, and formulaic hook templates — which is itself useful as a catalogue of what mechanical atomization looks like.)

---

## VERBATIM — complete `blog-repurpose/SKILL.md`
...
## NOT FETCHED / GAPS
- Sibling skills referenced but not reproduced here: `../blog/references/content-templates.md`, `../blog/references/distribution-playbook.md`.
