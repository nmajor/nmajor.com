# tropes.fyi — "A dynamic directory of the recurring tropes, tics and structural patterns that give away AI-generated text"

- URL: https://tropes.fyi/ (directory by ossama.is; the full trope file is served from the homepage as a downloadable markdown data: URL, decoded and reproduced below)
- Publication: tropes.fyi, an independent, continuously updated directory. Companion tools on the same site: "The Writing Whip" (a SKILL.md of 49 tropes + 10 behaviours), "ai;dr" (distils a slop article back to the prompt behind it), "AI Vetter", "Deslopify".
- Date accessed: 2026-08-18 (site states 49 tropes, 10 behaviours as of this capture)
- What it is: The single richest STRUCTURAL/RHETORICAL catalogue found. Every entry carries a category (Word Choice 6, Sentence Structure 9, Paragraph Structure 2, Tone 14, Formatting 5, Composition 13) AND a trend tag — `new`, `rising`, `consistent`, `fading` — which is unusual and useful: it tells you which tells are currently live versus already burned out. Every entry ships example strings.
- EVIDENCE TIER: **ASSERTED**. This is one practitioner's curated observation with examples, not a measurement. No corpus, no counts. Its value is the taxonomy and the examples, and the trend labels are the author's read, not data. The site is also opinionated/profane in places; quoted verbatim below.
- WHY IT MATTERS FOR OUR LANE: the `new` and `rising` entries are almost entirely composition- and structure-level, and most of them are NOT in our blacklist: premise stacking, preamble/announce-then-answer, compulsive counting, the Tie-Back, fractal summaries, excessive enumeration ("The first... The second..."), never-ending conclusion, one-point dilution, belaboring the unnecessary, self-echo, comma-clipped trailing phrase, invented concept labels, Wh-word headers, quotable one-liners, appeal to familiarity, collaborative "we".

## Categories and trend tags, as listed on the site

| Trope | Trend | Category |
|---|---|---|
| Negative parallelism | consistent | Sentence Structure |
| Em-dash addiction | consistent | Formatting |
| Short punchy fragments | rising | Paragraph Structure |
| Reasoning leak | new | Composition |
| Premise stacking | new | Composition |
| Preamble (announce-then-answer) | new | Composition |
| Grandiose stakes inflation | rising | Tone |
| Compulsive counting | new | Tone |
| Invented concept labels | rising | Tone |
| Rule of Three pattern | consistent | Sentence Structure |
| Belaboring the unnecessary | new | Composition |
| "Quietly" and other magic adverbs | consistent | Word Choice |
| The Tie-Back | consistent | Composition |
| Vague attributions | consistent | Tone |
| Self-echo | new | Composition |
| Quotable one-liners | new | Tone |
| Forced figurative language | new | Tone |
| Never-ending conclusion | new | Composition |
| Comma-clipped trailing phrase | new | Sentence Structure |
| Synonym cycling | new | Word Choice |
| Appeal to familiarity | new | Tone |
| Promotional language | new | Tone |
| "Where / What / Why" Headers | new | Formatting |
| "Where it actually lives" | new | Word Choice |
| Collaborative communication | consistent | Tone |
| "Not X. Not Y. Just Z." | consistent | Sentence Structure |
| "Here's the kicker" | consistent | Tone |
| Fractal summaries | rising | Composition |
| Excessive enumeration | rising | Paragraph Structure |
| Title case headings | consistent | Formatting |
| "Tapestry" and "Landscape" | consistent | Word Choice |
| "The X? A Y." | fading | Sentence Structure |
| Anaphora abuse | fading | Sentence Structure |
| Bold-first bullets | fading | Formatting |
| "Think of it as..." | fading | Tone |
| Unicode decoration | fading | Formatting |
| Rapid-fire historical analogies | fading | Composition |
| "Imagine a world where..." | fading | Tone |
| False vulnerability | fading | Tone |
| False ranges | fading | Sentence Structure |
| The "Serves As" dodge | fading | Word Choice |
| One-point dilution | fading | Composition |
| Content duplication | fading | Composition |
| "Delve" and friends | fading | Word Choice |
| "It's worth noting" | fading | Sentence Structure |
| "Let's break this down" | fading | Tone |
| Superficial analyses | fading | Sentence Structure |
| "Despite its challenges..." | fading | Composition |
| Signposted conclusion | consistent | Composition |

## Homepage framing, verbatim
...
Two behaviour instructions from The Writing Whip, verbatim (these are the ones that read as structural rules, not word bans):
...
> "Reasoning leak: Do not narrate what you are doing, deciding, planning or about to do. Do the thing and produce the output."
> "Compulsive counting: Do not state the number of items before listing them. Do not enumerate or count anything explicitly."

## FULL TROPE FILE, VERBATIM (decoded from the site's own markdown export, 2026-08-18)
