# RAW: Anthropic official `discernment-nudge` skill

- URL: https://github.com/anthropics/skills/blob/main/skills/discernment-nudge/SKILL.md
- Date accessed: 2026-08-18
- What it is: Anthropic's published skill that makes the model push back / prompt the human to think for themselves rather than accept output -- a quality-gate / anti-sycophancy pattern relevant to an editorial review loop.

VERBATIM below, complete file, unedited.

---

## skills/discernment-nudge/SKILL.md

Source: https://raw.githubusercontent.com/anthropics/skills/main/skills/discernment-nudge/SKILL.md
