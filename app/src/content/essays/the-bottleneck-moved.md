...
Here's the part that should change what you do Monday. The companies getting real value aren't the ones with a better model. McKinsey's surveys keep finding the strongest predictor of AI reaching the bottom line is whether a company [redesigned the workflow](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) instead of bolting AI onto the old one. That redesign is the real work, and [the process has to come before the tool](/writing/fix-the-process-first/), not after: put AI on top of a workflow that was already a mess and all you get is the mess, faster. And when Gartner studied 350 companies, the ones chasing returns purely through headcount cuts got [limited returns; the value came from making people more productive](https://fortune.com/2026/05/11/ai-automation-layoffs-gartner-study-roi/), not replacing them.
