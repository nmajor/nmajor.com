# RAW: ComposioHQ/awesome-claude-skills -- content-research-writer skill + the awesome-list README

- Repo: https://github.com/ComposioHQ/awesome-claude-skills
- Skill: https://github.com/ComposioHQ/awesome-claude-skills/blob/master/content-research-writer/SKILL.md
- Date accessed: 2026-08-18
- What it is: A widely-referenced community curated list of Claude Skills, plus its own `content-research-writer` skill (research -> citations -> hook improvement -> section-by-section feedback). The README doubles as a catalogue of what writing/marketing skills exist publicly.
...
Source: https://raw.githubusercontent.com/ComposioHQ/awesome-claude-skills/master/content-research-writer/SKILL.md
...
Source: https://raw.githubusercontent.com/ComposioHQ/awesome-claude-skills/master/README.md
