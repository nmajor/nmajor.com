...
| 2026-08-11 | Curative | Healthcare / health insurance | saas | Vibecoded a replacement CRM in ~2 months and cancelled Salesforce — while model spend grew ~6x a month | $600k/yr contract cancelled; SaaS spend -80% planned; token bill tens of thousands → millions/mo | xchk | [curative-vibecoded-crm-salesforce](entries/curative-vibecoded-crm-salesforce.md) |
| 2026-08-11 | Kinney Drugs | Retail pharmacy | fail | AI phone assistant "Burt" gave wrong dosages and missed refills; incoming patient calls reverted to touch-tone after ~3 months | "Hundreds" of complaints; May → Aug 2026 | read | [kinney-drugs-burt-phone-rollback](entries/kinney-drugs-burt-phone-rollback.md) |
| 2026-08-11 | Lemvigh-Müller | Wholesale distribution (steel) | proc | SAP agents onto supplier order confirmations in an existing procurement process, aiming at touchless handling | ~100k manual confirmations/yr targeted (vendor-reported); no outcome numbers | read | [lemvigh-muller-order-confirmations](entries/lemvigh-muller-order-confirmations.md) |
